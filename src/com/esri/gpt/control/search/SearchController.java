...
throws AbortProcessingException, Exception {
	ActionEvent a= event;
	RequestContext n = context;
	
	//download file
	UIComponent component = event.getComponent();
    String sCommand = Val.chkStr((String)component.getAttributes().get("command"));
    String idd = Val.chkStr((String)component.getAttributes().get("idd"));
	if(sCommand.equals("download"))downloadFile();
